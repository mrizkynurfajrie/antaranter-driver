...
import 'package:antaranter_driverapp/features/customer_posting/filter_nebeng_posting_page.dart';
import 'package:antaranter_driverapp/features/customer_posting/nebeng_posting_item.dart';
import 'package:antaranter_driverapp/features/customer_posting/nebeng_posting_shimmer.dart';
                      ...
                      ? controller.listCustomerNebeng.isNotEmpty
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) =>
                                  NebengPostingItem(
                                      nebengPost:
                                          controller.listCustomerNebeng[index]),
                            )
                          : Column(
...
Widget filterWidget(ControllerCustomerPosting controller) => CardRounded(
      color: AppColor.bgPageColor,
      borderRadius: 0,
      shadow: [],
      margin: EdgeInsets.zero,
