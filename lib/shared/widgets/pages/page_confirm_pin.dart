...
class PageConfirmChangePin extends StatefulWidget {
  const PageConfirmChangePin({
    Key? key,
  }) : super(key: key);
  @override
  _PageTemplateConfirmChangePinState createState() =>
      _PageTemplateConfirmChangePinState();
}

class _PageTemplateConfirmChangePinState extends State<PageConfirmChangePin> {
  String pin = '';
