...
class NebengPostingResponse {
  ...
  factory NebengPostingResponse.fromJson(Map<String, dynamic> json) =>
      NebengPostingResponse(
        ...
        nebengOrder: json["data"] == null
            ? null
            : List<NebengOrder>.from(
                json["data"].map((x) => NebengOrder.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "data": nebengOrder == null
            ? null
            : List<NebengOrder>.from(nebengOrder!.map((x) => x.toJson())),
      };
}
